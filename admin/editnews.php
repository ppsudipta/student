       ...
       <form  role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
              <div class="box-body">
			   <div class="form-group">
                  <label for="productid">News Name</label>
                  <input class="form-control" name="e_name" value="<?php echo $row['name'];?>" required  placeholder="Enter Name" type="text">
                </div>
				<div class="form-group">
                  <label for="productid">News Details</label>
                  <input class="form-control" value="<?php echo $row['description']; ?>" name="details"  required  placeholder="Enter description" type="text">
                </div>
				
				<div class="form-group">
                  <label for="productid">News Date</label>
...
{
$news_name=$_POST['e_name'];
	$news_details=$_POST['details'];
	//$area=$_POST['area'];
	$date=$_POST['date'];
	...
	$sql= "UPDATE news SET name='$news_name', image='$path1', description='$news_details', date='$date' where id='$id'";
     $con->query($sql); 
	echo "<script>alert('Edit successfull')</script>";	
	echo "<script>window.location.href='allnews.php'</script>";	
	}
}
