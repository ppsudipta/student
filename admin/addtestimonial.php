           ...
           <form  role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
              <div class="box-body">
			   <div class="form-group">
                  ...
                  <input class="form-control" name="student_name"  required  placeholder="Enter Name" type="text">
                </div>
				<div class="form-group">
                  <label for="productid">Comments</label>
                  <input class="form-control" name="comment"  required  placeholder="Enter comment" type="text">
                </div>
...
if(isset($_POST['submit']))
{
	...
	{
	$sql="insert into testimonial values('','$student_name','$path1','$comment','$date') ";
