...
{
	$del=$_GET['del_id'];
	$sql2="delete from pdf where id='$del'";
	$con->query($sql2);
}
?>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Pdf Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<?php
 ...
 ?>   
                ...
                <tr>
                  ...
                  <td><a href="<?php echo $row['pdf']; ?>"><?php echo $row['pdf']; ?></a></td>
                  
                 <!-- <td><a href="editslider.php?id=<?php echo $row['id']?>"><button class="btn btn-warning">
				  <i class="fa fa-pencil"></i></button></a></td>-->
                  
                 
                   <td><a onclick="return confirm('Are you sure to Delete?');" href="allpdf.php?del_id=<?php echo $row['id']?>">
