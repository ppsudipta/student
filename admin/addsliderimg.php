           ...
           <form  role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
              <div class="box-body">
			   <div class="form-group">
                  ...
                  <input class="form-control" name="Slider_name"  required  placeholder="Enter Slider Name" type="text">
                </div> 
				<div class="form-group">
                  <label for="productid">Slider Details</label>
                  <input class="form-control" name="details"  required  placeholder="Enter Slider details" type="text">
                </div>
				...
				<div class="form-group">
				  ...
				  <p>*image width-1920px and height-1080px</p>
                </div>
...
if(isset($_POST['submit']))
{
	...
	{
	$sql="insert into slider values(null,'$Slider_name','$details','$path1','$date') ";
