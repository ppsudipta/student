        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Income Report Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
	...
	if(isset($_POST['e_date']))
{
	...
	$sql="SELECT * FROM fees_table WHERE fees_date BETWEEN '$s_date' AND '$e_date'";
	//echo $sql;
	$res=$con->query($sql);
 ...
 ?>   
                ...
                <tr>
                 ...
                 <td><?php echo $row['fees_date'] ?></td>
                   ...
                   <td>
				   <button class="btn btn-danger" onclick="myFunction()"><i class="fa fa-print"></i></button></a></td>
...
?>  
<?php
$sql2="SELECT SUM(fees) AS 'Total Income' FROM fees_table WHERE fees_date BETWEEN '$s_date' AND '$e_date'";
	//echo $sql2;
		$res2=$con->query($sql2);
...
?> 
         ...
         <div class="col-xs-6"><h4  class="text-center text-success"><b>Total</b></h4></div>  <div  class="col-xs-6 text-success"><h4 class="text-center"><b>Rs.<?php echo $row2['Total Income'];?></b></h4></div>
		 <?php
