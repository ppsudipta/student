        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Testimonial Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
 ...
 ?>   
                ...
                <tr>
                 ...
                 <td><?php echo $row['date'] ?></td>
                  <td><a href="edittestimonial.php?id=<?php echo $row['id']?>"><button class="btn btn-warning">
				  <i class="fa fa-pencil"></i></button></a></td>
                  
                 
                   <td><a onclick="return confirm('Are you sure to Delete?');" href="alltestimonial.php?id=<?php echo $row['id']?>">
