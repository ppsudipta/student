	...
	?>
       ...
       <form  role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			...
			<div class="box-footer">
                <button type="submit" name="submit" class="btn btn-primary">Update Services</button>
              </div>
            </form> 
			</div>
            <!-- /.box-body -->
...
if(isset($_POST['submit']))
{
	...
	$sql= "UPDATE exam SET name='$name', image='$path1', details='$details', conducted_by='$conduct_by' where id='$id'";
     $con->query($sql); 
