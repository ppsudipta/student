        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Courses here</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
 ...
 ?>   
                ...
                <tr>
                 ...
                 <td><?php echo $row['price'] ?></td>
                  <td><a href="editpack.php?id=<?php echo $row['id']?>"><button class="btn btn-warning">
				  <i class="fa fa-pencil"></i></button></a></td>
                  
                 
                   <td><a onclick="return confirm('Are you sure to Delete?');" href="allpack.php?id=<?php echo $row['id']?>">
