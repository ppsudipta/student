           ...
           <form  role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
              <div class="box-body">
			   <div class="form-group">
                  <label for="productid">Sub Category Name</label>
				...
				<div class="form-group">
                  <label for="name">Sub Category Image</label>
...
if(isset($_POST['submit']))
{
	...
	{
	$sql="insert into subcategory values('','$category_name','$subcategory_name','$path1') ";
	
	$con->query($sql);
	echo "<script>alert('successfully added')</script>";	
	echo "<script>window.location.href='allsubcategory.php'</script>";	
	}
}
