	...
	?>
		...
		<form  role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				...
				<div class="form-group">
                  ...
                  <input class="form-control" name="sname"  required  placeholder="Enter Name " type="text" value="<?php echo $row['name'];?>">
                </div>
				<div class="form-group">
                  <label for="productid">Username</label>
                  <input class="form-control" name="uname"  required  placeholder="Enter username" type="text" value="<?php echo $row['username'];?>">
                </div>
				<div class="form-group">
                  <label for="productid">Email </label>
                  <input class="form-control" name="email" placeholder=" Email Id"  type="text" value="<?php echo $row['email'];?>">
                </div>
				 <div class="form-group">
...
if(isset($_POST['submit']))
{
 ...
 $hashed_password = password_hash($password, PASSWORD_DEFAULT);
	...
	$sql4="UPDATE `admin` SET `name`='$sname',`username`='$uname',`email`='$email',`password`='$hashed_password'";
	$con->query($sql4); 
