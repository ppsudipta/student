        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Details Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<?php
 ...
 ?>   
				...
				<td><img src="<?php echo $row['logo']; ?>" style="width:120px;"></td>
				...
				<td><?php echo $row['you'] ?></td>
				<td><?php echo $row['insta'] ?></td>
                <td><a href="editcompany.php?id=<?php echo $row['id']?>"><button class="btn btn-warning">
