        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Add Expence</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
           <form  role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
              <div class="box-body">
			   <div class="form-group">
                  <label for="productid">Expence Amount</label>
                  <input class="form-control" name="amount"  required  placeholder="Enter Amount" type="text">
                </div>
				<div class="form-group">
                  <label for="productid">Expence Reason</label>
                  <input class="form-control" name="reason"  required  placeholder="Enter Reason" type="text">
                </div>
				
				<div class="form-group">
                  <label for="productid">Expence Date</label>
...
if(isset($_POST['submit']))
{
	...
	{
	$sql="insert into expence values('','$amount','$reason','$date') ";
	
	$con->query($sql);
	echo "<script>alert('successfully added')</script>";	
	echo "<script>window.location.href='allexpence.php'</script>";	
	}
}
