  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">All Expence</li>
      </ol>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Expence</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
           <form  role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8" action="expence_print.php">
              <div class="box-body">
			  <div class="col-md-6">
			   <div class="form-group">
                  <label for="productid">Start Date</label>
                  <input class="form-control" name="s_date"  required  placeholder="Ex:dd/mm/yyyy" type="date">
                </div>
				</div>
				<div  class="col-md-6"> 
				<div class="form-group">
                  <label for="productid">End Date</label>
                  <input class="form-control" name="e_date"  required  placeholder="Ex:dd/mm/yyyy" type="date">
                </div>
				</div>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Expence Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
