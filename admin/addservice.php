           ...
           <form  role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
              <div class="box-body">
			   <div class="form-group">
                  ...
                  <input class="form-control" name="c_name"  required  placeholder="Enter Name" type="text">
                </div>
				<div class="form-group">
                  <label for="productid">Service Details</label>
                  <input class="form-control" name="details"  required  placeholder="Enter Name" type="text">
                </div>
					<!--<div class="form-group">
                  <label for="productid">Course Teacher</label>
                  <input class="form-control" name="teacher"    placeholder="Enter Teacher Name" type="text">
                </div>
				<div class="form-group">
                  <label for="productid">Course Duration</label>
                  <input class="form-control" name="duration"    placeholder="Enter Duration" type="text">
                </div>
			<div class="form-group">
...
if(isset($_POST['submit']))
{
	...
	{
	$sql="insert into service values('','$name','$path1','$details','$date') ";
