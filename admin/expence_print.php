	...
	if(isset($_POST['e_date']))
{
	...
	$sql="SELECT * FROM expence WHERE date BETWEEN '$s_date' AND '$e_date'";
	//echo $sql;
	$res=$con->query($sql);
...
?>  
<?php
$sql2="SELECT SUM(amount) AS 'Total Expence' FROM expence WHERE date BETWEEN '$s_date' AND '$e_date'";
	//echo $sql2;
		$res2=$con->query($sql2);
...
?> 
          ...
          <div class="col-xs-6"><h4  class="text-center text-success"><b>Total</b></h4></div>  <div  class="col-xs-6 text-success"><h4 class="text-center"><b>Rs.<?php echo $row2['Total Expence'];?></b></h4></div>
		 <?php
