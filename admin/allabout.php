        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All About Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
 ...
 ?>   
                ...
                <tr>
				 ...
				 <td><img style="height:70px; width:100px" src="<?php echo $row['image']; ?>"></td>
                  ...
                  <td><a href="editabout.php?id=<?php echo $row['id']?>"><button class="btn btn-warning"><i class="fa fa-pencil"></i></button></a></td>
                  
                 
                   <td><a onclick="return confirm('Are you sure to Delete?');" href="allabout.php?id=<?php echo $row['id']?>">
