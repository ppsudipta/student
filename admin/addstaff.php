           ...
           <form  role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
              <div class="box-body">
			   <div class="form-group">
                  ...
                  <input class="form-control" name="name"  required  placeholder="Enter Name" type="text">
                </div>
			   <div class="form-group">
                  <label for="productid">Staff Email</label>
                  <input class="form-control" name="email"  required  placeholder="Enter Email" type="email">
                </div>
				<div class="form-group">
                  <label for="productid">Staff Phone</label>
                  <input class="form-control" name="phone"  required  placeholder="Enter Phone" type="text">
                </div>
				<div class="form-group">
                  <label for="productid">Staff Password</label>
                  <input class="form-control" name="password"  required  placeholder="Enter Password" type="text">
                </div>
				<!--<div class="form-group">
				...
				<div class="form-group">
                  ...
                  <input class="form-control" name="image1" type="file" required accept="image/x-png">
                </div>
				<p>Note: Use only PNG logo</p>-->
...
if(isset($_POST['submit']))
{
	...
	{
	$sql="insert into staff values('','$name','$email','$phone','$password')";
