       ...
       <form  role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
              <div class="box-body">
			   <div class="form-group">
                  ...
                  <input class="form-control" name="c_name" value="<?php echo $row['name'];?>" required  placeholder="Enter Name" type="text">
                </div>
				<div class="form-group">
				...
				<div class="form-group">
                  ...
                  <input class="form-control" value="<?php echo $row['teacher'] ?>" name="teacher"    placeholder="Enter Teacher Name" type="text">
                </div>
				<!--<div class="form-group">
...
$course_name=$_POST['c_name'];
	...
	$sql= "UPDATE course SET name='$course_name', image='$path1', details='$details', teacher='$teacher' where id='$id'";
     $con->query($sql); 
	echo "<script>alert('Edit successfull')</script>";	
	echo "<script>window.location.href='allimage.php'</script>";	
	}
}
