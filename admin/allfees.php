...
$del_id=$_GET['del_id'];
	...
	{
		$sql="DELETE from fees_table where id=$del_id";
		//$sql="UPDATE fees SET amount='',fees_date='' where id='$del_id'";
		$con->query($sql);
		echo "<script>alert('Fee deleted')</script>";	
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All fees Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
if(isset($_GET['id']))
{
	...
	{
	$sql="select * from fees_table where student_code='$code' and course='$course' ORDER BY ID DESC";
	$res=$con->query($sql);
	?>
 ...
 ?>   
                ...
                <tr>
                 ...
                 <td><a href="editfee.php?id=<?php echo $row['id']?>"><button class="btn btn-warning">
				  <i class="fa fa-pencil"></i></button></a></td>
                  <td><a onclick="return confirm('Are you sure to Delete?');" href="allfees.php?del_id=<?php echo $row['id']?>">
				   <button class="btn btn-danger"><i class="fa fa-trash"></i></button></a></td>
				<td><a href="printfee.php?id=<?php echo $row['id']?>"><button class="btn btn-warning">
