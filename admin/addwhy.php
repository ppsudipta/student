           ...
           <form  role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
              <div class="box-body">
			   <div class="form-group">
                  <label for="productid">Services Heading</label>
                  <input class="form-control" name="c_name"  required  placeholder="Enter Name" type="text">
                </div>
				<div class="form-group">
                  <label for="productid">Services Details</label>
				...
				<div class="form-group">
                  <label for="name">Services Icon</label>
...
if(isset($_POST['submit']))
{
	...
	{
	$sql="INSERT INTO `exam`(`id`, `name`, `conducted_by`, `details`, `image`, `date`) VALUES ('','$name','$conduct_by','$details','$path1','$date') ";
	
	$con->query($sql);
	echo "<script>alert('successfully added')</script>";	
	echo "<script>window.location.href='allwhy.php'</script>";	
	}
}
