              ...
              <div class="box-body">
			   <!--<div class="form-group">
				...
				<div class="form-group">
                  ...
                  <input class="form-control" value="<?php echo $name; ?>" name="name"  required  type="text">
                </div>
				<div class="form-group">
				...
				<div class="form-group">
                  ...
                  <input class="form-control" value="<?php echo $address; ?>" name="address"  required  placeholder="Enter Address" type="text">
                </div>
				
				<div class="form-group">
                  <label for="productid">Phone No 1</label>
                  <input class="form-control" value="<?php echo $ph1; ?>" name="ph1"  required  placeholder="Enter Primary Phone NO." type="text">
                </div>
				<div class="form-group">
                  <label for="productid">Alter Phone No.</label>
                  <input class="form-control" value="<?php echo $ph2; ?>" name="ph2"  required  placeholder="Enter Alternative Phone NO." type="text">
                </div>
				<div class="form-group">
                  <label for="productid">Whatsapp No.</label>
                  <input class="form-control" name="wp" value="<?php echo $wp; ?>" required  placeholder="Enter Whatsapp Phone NO." type="text">
                </div>
				
				
				<div class="form-group">
                  <label for="productid">Email Id</label>
                  <input class="form-control" value="<?php echo $email; ?>" name="email"  required  placeholder="Enter Email Id" type="email">
                </div>
				<div class="form-group">
                  <label for="productid">Facebook Link</label>
                  <input class="form-control" name="fb"  value="<?php echo $fb; ?>"  placeholder="Enter Facebook Link" type="url">
                </div>
				<div class="form-group">
                  <label for="productid">Youtube Link</label>
                  <input class="form-control" name="you"  value="<?php echo $you; ?>"  placeholder="Enter Youtube Link" type="url">
                </div>
				<div class="form-group">
                  <label for="productid">Instagram Link</label>
                  <input class="form-control" name="insta"  value="<?php echo $insta; ?>"   placeholder="Enter Instagram Link" type="url">
                </div>
...
{
$sql="UPDATE `company` SET `name`='$name',`logo`='$path1',`address`='$address',`ph1`='$ph1',`ph2`='$ph2',`wp`='$wp',`email`='$email', `fb`='$fb', `you`= '$you', `insta`='$insta' WHERE id='$id'";
