...
Route::get('/about', [StudentApiController::class, 'about']);
Route::get('/legal-policies', [StudentApiController::class, 'legalPolicies']);
Route::get('/enquiry-categories', [StudentApiController::class, 'enquiryCategories']);
...
Route::post('/device-token', [StudentApiController::class, 'registerDeviceToken']);
Route::post('/device-token/unregister', [StudentApiController::class, 'unregisterDeviceToken']);
Route::post('/push/notices', [StudentApiController::class, 'pushNotices']);
...
Route::get('/enquiries/{id}', [StudentApiController::class, 'showEnquiry'])->whereNumber('id');
Route::post('/enquiries/{id}/messages', [StudentApiController::class, 'addEnquiryMessage'])->whereNumber('id');
